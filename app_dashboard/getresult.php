...
<div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-list-ol fa-5" aria-hidden="true"></i>All Categories</h3>
...
{foreach($faq as $k=>$v) { ?>
                <tr>
                                   ...
                                   <td><?php echo $faq[$k]['category_name'];?></td>
                  <td><img src="<?php echo $faq[$k]['category_image'];?>" height="100" width="100"></td>
                  <td><a href="editcategory.php?id=<?php echo base64_encode($faq[$k]['cat_id']);?>"><button class=" btn btn-primary btn-warning" >Edit<i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                  <td><a href="deletecategory.php?id=<?php echo base64_encode($faq[$k]['cat_id']);?>" class="btn btn-social-icon btn-google" onClick="return checkDelete()" ><i class="fa fa fa-trash-o"></i></a>
