            ...
            <div class="box-header">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">Please upload gif,jpg,jpeg,bmp,png files only.<br>If added new older image will be replaced. If you do not want to delete leave this blank</p>
                </div>
